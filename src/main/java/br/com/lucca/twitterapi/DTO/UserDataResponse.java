...
@JsonPropertyOrder({ "id", "id_str", "name", "screen_name", "location", "description", "url", "protected",
		...
		"follow_request_sent", "notifications", "translator_type", "withheld_in_countries", "suspended",
